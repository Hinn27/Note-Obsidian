...
*(Sử dụng để chia màn hình Terminal, hữu ích khi cần mở Server, xem Log chạy song song với Code)*
...
*(Sử dụng để di chuyển bên trong bản thân phần mềm Neovim)*
